...
* `GET _snapshot/<repository>/<snapshot>/_status` returns detailed status information of a specific snapshot in a specific repository, regardless of whether it is currently running or not.
